...
public class N_SearchAccount extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.n_searchaccount);
            ...
            public void onClick(View v) {
                databaseReference.child(id.getText().toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(item == null){
                            Toast.makeText(N_SearchAccount.this, "아이디가 잘못되었습니다", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(N_SearchAccount.this, "힌트 문항 혹은 답이 잘못되었습니다", Toast.LENGTH_SHORT).show();
                        }
